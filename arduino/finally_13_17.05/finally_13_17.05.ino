...
#define STBY 8
#define spe  255
#define delayend_time 3000   //终点转向持续时间
#define delay_time_fow 3000  //前进状态停止的时间
#define delay_time_stop 3000     //识别到红色十字入口并决定停止的停止时间
#define delay_time_turn 3000
#define turn 500            //转向时候的速度
#define base 100            //基准速度
#define R_bit 0
#define L_bit 1
